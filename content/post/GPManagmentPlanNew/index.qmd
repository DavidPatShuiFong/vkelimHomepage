---
title: Calculating the combined impact of new GP Chronic Condition Management Plan service items and universal bulk-billing
date: "2025-05-27"
format: hugo-md
...
- care-plans
engine: knitr
summary: "Using an online dashboard calculator to estimate the combined impact of the universal bulk-billing incentives and new chronic condition management plans on practice revenue"
---
...
![Current mean fees](images/Practice_meanfees_current_table.png)
...
An example calculation of the effect, using the [dashboard calculator](https://shiny.davidfong.org/universalbulkbilling/), is shown in @fig-businessasusual.

![Business as usual](images/Practice_businessasusual.jpeg){#fig-businessasusual}
...
![Current mean fees](images/Practice_meanfees_businessasusual_table.png)
...
![](images/Practice_967to965_1to1.jpeg){#fig-morereviews}

At last the service mean-fee of $92.89 now exceeds the 'current' mean fee.

If this practice adopts universal bulk-billing, the mean service-fee will be $104.36. The calculation can be done for a range of possible 967:932 ratios, as shown in @fig-fulltable and @fig-reviewratioplot.

![](images/Practice_meanfees_fulltable.png){#fig-fulltable}

![](images/CDM_967to965ratio_UBB.png){#fig-reviewratioplot}
