...
'<div class="masonry js-masonry" data-masonry-options=\'{ "itemSelector": ".masonry-grid-item", "columnWidth": 80, "gutter": 0}\'>',
'<div class="masonry-grid-item"><a data-fancybox="gallery" href="./20220106_Epiphany_Clinic.jpg">',
'<img src="./20220106_Epiphany_Clinic.jpg" width="300px" style="margin:0px 0px">', # default CSS top/bottom margin is not zero
'</a></div>',
'<div class="masonry-grid-item"><a data-fancybox="gallery" href="./20220106_Epiphany_Disability.jpg">',
'<img src="./20220106_Epiphany_Disability.jpg" width="300px" style="margin:0px 0px">',
'</a></div>',
'<div class="masonry-grid-item"><a data-fancybox="gallery" href="./20220106_Epiphany_Residence.jpg">', 
'<img src="./20220106_Epiphany_Residence.jpg" width="300px" style="margin:0px 0px">',
'</a></div>',
'<div class="masonry-grid-item"><a data-fancybox="gallery" href="./20220106_Epiphany_Child.jpg">',
'<img src="./20220106_Epiphany_Child.jpg" width="300px" style="margin:0px 0px">',
'</a></div>',
'</div>'
))
```
