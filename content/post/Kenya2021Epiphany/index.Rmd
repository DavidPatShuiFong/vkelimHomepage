...
'<div class="masonry js-masonry" data-masonry-options=\'{ "itemSelector": ".masonry-grid-item", "columnWidth": 60, "percentPosition": "true", "gutter": 0}\'>',
'<div class="grid-sizer"></div>',
'<div class="masonry-grid-item" style="float:left; width:40%"><a data-fancybox="gallery" href="./20220106_Epiphany_Clinic.jpg">',
'<img src="./20220106_Epiphany_Clinic.jpg" style="margin:0px 0px">', # default CSS top/bottom margin is not zero
'</a></div>',
'<div class="masonry-grid-item" style="float:left; width:40%"><a data-fancybox="gallery" href="./20220106_Epiphany_Disability.jpg">',
'<img src="./20220106_Epiphany_Disability.jpg" style="margin:0px 0px">',
'</a></div>',
'<div class="masonry-grid-item" style="float:left; width: 40%"><a data-fancybox="gallery" href="./20220106_Epiphany_Residence.jpg">', 
'<img src="./20220106_Epiphany_Residence.jpg" style="margin:0px 0px">',
'</a></div>',
'<div class="masonry-grid-item" style="float:left; width: 40%"><a data-fancybox="gallery" href="./20220106_Epiphany_Child.jpg">',
