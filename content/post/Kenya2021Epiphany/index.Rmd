...
'<div class="isotope-grid-item" style="float:left; width:48%"><a data-fancybox="gallery" href="./20220106_Epiphany_Disability.jpg">',
'<img src="./20220106_Epiphany_Disability.jpg" style="margin:0px 0px">',
'</a></div>',
'<div class="isotope-grid-item" style="float:left; width:48%"><a data-fancybox="gallery" href="./20220106_Epiphany_Child.jpg">',
'<img src="./20220106_Epiphany_Child.jpg" style="margin:0px 0px">',
'</a></div>',
'<div class="isotope-grid-item" style="float:left; width:48%"><a data-fancybox="gallery" href="./20220106_Epiphany_Clinic.jpg">',
'<img src="./20220106_Epiphany_Clinic.jpg" style="margin:0px 0px">', # default CSS top/bottom margin is not zero
'</a></div>',
'<div class="isotope-grid-item" style="float:left; width:48%"><a data-fancybox="gallery" href="./20220106_Epiphany_Residence.jpg">', 
