...
new_service_fees <- c(
  ...
  c(164.35, 130.25, 82.10)
)
new_gap_fee <- c(
  rep(35, 5),
  # no gap fees were charged for these items, even 'private' patients
  rep(0, 3)
)
  ...
  tibble(
    ...
    Metro = num(
      short_service_list*(1+universal_bulkbill_incentive)+
        individual_bulkbill_incentive[1],
      digits = 2
    ),
    Regional = num(
      short_service_list*(1+universal_bulkbill_incentive)+
        individual_bulkbill_incentive[2],
      digits = 2
    ),
    `Large Rural` = num(
      short_service_list*(1+universal_bulkbill_incentive)+
        individual_bulkbill_incentive[3],
      digits = 2
    ),
    `Small Rural` = num(
      short_service_list*(1+universal_bulkbill_incentive)+
        individual_bulkbill_incentive[4],
      digits = 2
    ),
    Remote = num(
      short_service_list*(1+universal_bulkbill_incentive)+
        individual_bulkbill_incentive[5],
      digits = 2
    ),
  )
