...
# percentage change in revenue vs pre-existing gap fee and 'private'-billing proportion
...
fig_plotly_3d <- plot_ly(
  data = profit_loss_practice_standard,
  x = ~gap, y = ~private_billed, z = ~profit_rel * 100,
  ...
  layout(
    title = "Revenue change (%) according to gap fee and proportion privately-billed",
    scene = list(
      xaxis = list(title = list(text = "Gap fee ($)")),
      yaxis = list(title = list(text = "Privately-billed (%)")),
