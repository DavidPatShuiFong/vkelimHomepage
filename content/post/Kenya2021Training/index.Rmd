...
blogdown::shortcode('video', library = 'true', src = 'SpurCentre_TrainingVideo.mp4', controls = 'yes')

# alternatively the video shortcode could be (because the shortcode doesn't always get interpreted into correct HTML?)
# <p>
#  <video controls = "">
