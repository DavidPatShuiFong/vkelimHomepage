...
* Copy the script to `[ROOT]/layouts/partials/comments/utterances.html`
  ...
  + So, create the file `[ROOT]/layout/partials/comments/utterances.html`, **not**
    `[ROOT]/themes/hugo-academic/layout/partials/comments/utterances.html`
...
* Then I reference the script in `[ROOT]/layouts/partials/comments.html`
  + **not** `[ROOT]/themes/hugo-academic/layout/partials/comments.html`
