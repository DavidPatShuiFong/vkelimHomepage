...
modelplot(
  ...
  labs(
    x = "Odds ratio co-efficient estimates and 95% confidence intervals",
    y = "Predictors",
    title = "'Mental Health Care Plan' billed in previous twelve months",
...
table_mh2713_model <- modelsummary(
  models = list(
    "Logistic model" = model_mh2713,
    "Logistic model - clinic random effect" = model_mh2713_effects
  ),
  estimate = c("Odds ratio" = "{estimate}"),
  coef_rename = c(
    "concessionTRUE" = "Concession holder",
...
modelplot(
  ...
  labs(
    x = "Odds ratio co-efficient estimates and 95% confidence intervals",
    y = "Predictors",
    title = "Mental health item 2713 consults billed in previous twelve months",
    caption = "(coHealth GP clinics, May 2025)"
  )
```
...
table_gpmp_model <- modelsummary(
  models = list(
    "Logistic model" = model_gpmp,
    "Logistic model - clinic random effect" = model_gpmp_effects
  ),
  estimate = c("Odds ratio" = "{estimate}"),
  coef_rename = c(
    "concessionTRUE" = "Concession holder",
...
modelplot(
  ...
  labs(
    x = "Odds ratio co-efficient estimates and 95% confidence intervals",
    y = "Predictors",
    title = "'Chronic Disease Care Plan' billed in previous twelve months",
    caption = "(coHealth GP clinics, May 2025)"
  )
```