...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _www.davidfong.info/_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://www.davidfong.info/cv/raw/master/fong_cv.pdf)")
}
```
...
The source code is available [on github.com/DavidPatShuiFong/](https://github.com/DavidPatShuiFong/vkelimHomepage/content/post/CV).
